...
import { setTimeOffViewPreference } from "@/lib/time-off-view-preference";
...
export default function ClassicTimeOffPage() {
  ...
  // Remember classic as the preferred view while on this page.
  useEffect(() => {
